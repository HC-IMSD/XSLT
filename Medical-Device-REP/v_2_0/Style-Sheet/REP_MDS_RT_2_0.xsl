...
.nav a, a.btn {
	...
	<xsl:template name="mybody">
		<h1>Regulatory Transaction Template: Regulatory Enrolment Process (REP) (Version: 2.0)</h1>
				...
				<div class="panel-body">
							...
							<div class="panel-body">
								...
								<div class="row">
									...
									<xsl:if test="/descendant-or-self::application_info/org_manufacture_id != ''">
										<div class="col-xs-6">
											<strong>Orginal Manufacturer's Company Identifier:&#160;</strong>
											<span class="mouseHover"><xsl:value-of select="/descendant-or-self::application_info/org_manufacture_id"/></span>
										</div>
										<div class="col-xs-6">
											<strong>Orginal Manufacturer's Licence Number:&#160;</strong>
									...
									<div class="col-xs-5">
										<strong>Is this solicited information?&#160;</strong>
					...
					<section class="panel panel-default" >
						<div class="panel-heading"  style="color:#030303; background-color:#f8f8f8;">
							<h3 class="panel-title">Transaction Requester Information</h3>
						</div>
						<div class="panel-body">
							<table class="table dataTable table-bordered table-hover table-condensed table-striped">
								<thead>
									<tr><th>&#160;</th><th><strong>Requester of Solicited Information</strong></th></tr>
								</thead>
								<tbody>
									<xsl:if test="count(/descendant-or-self::requester_of_solicited_information/requester/id) > -1 ">
