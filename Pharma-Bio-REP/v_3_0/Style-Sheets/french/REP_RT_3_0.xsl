										...
										<xsl:for-each select="ectd/lifecycle_record">
													<fieldset>
														...
														<div class="row">
															...
															<div class="col-xs-6">
															<strong>Type d'activit&#233; r&#233;glementaire:&#160;</strong><span class="mouseHover"><xsl:value-of select="regulatory_activity_type"/></span>
															</div>
														</div>
														<div class="row">
															<div class="form-group col-md-12">
															<strong>Description de transactions de r&#233;glementation :&#160;</strong><span class="mouseHover">
															<xsl:choose>
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="well well-sm" >
						<div class="row">
							<div class="col-xs-12">
								<strong>Un paiement diff&#233;r&#233; est demand&#233; avec cette transaction&#160; </strong>
							...
							<div class="col-xs-12">
								<strong>Une remise de frais est demand&#233; avec cette transaction?&#160; </strong>
							...
							<div class="col-xs-12">
								<strong>Les recettes brutes pr&#233;vues pour ce m&#233;dicament pour la p&#233;riode de v&#233;rification des frais payer:&#160; </strong>
							...
							<div class="col-xs-12">
								...
								Vous n’êtes pas admissible &#224; une remise des frais. Les frais de soumission sont inf&#233;rieurs &#224; 10 % des recettes brutes pr&#233;vues.
								</div>
								</xsl:when>
								<xsl:otherwise>
								<div class="alert alert-success">
								Vous êtes admissible &#224; pr&#233;senter une demande de remise des frais. Les frais de soumission sont sup&#233;rieurs &#224; 10 % des recettes brutes pr&#233;vues.
								</div>
								</xsl:otherwise>
								</xsl:choose>
							</div>
					...
					<div class="well well-sm" >
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<span class="mouseHover">La d&#233;claration &#224; l’appui de la demande de report de paiement est  inclus.</span>
							</div>
						</div>
						</xsl:if>
						...
						<div class="row">
							<div class="col-xs-12">
								<strong>Veuillez inclure la d&#233;claration exig&#233;e sign&#233;e ET au moins un des documents de soutien pour l’&#233;tablissement des frais applicables sup&#233;rieurs &#224; 10 % des revenus bruts pr&#233;vus pour les ventes du produit au Canada au cours de la p&#233;riode de v&#233;rification.</strong>
							</div>
							<div class="col-xs-12">
								...
								<span class="mouseHover">Une d&#233;claration sign&#233;e par le responsable des affaires financi&#232;res du demandeur est inclus pour attester que les frais payables sont plus &#233;lev&#233;s que 10% des revenus
bruts anticip&#233;s.</span>
							</div>
							<div class="col-xs-12">
								...
								<span class="mouseHover">La part estim&#233;e du march&#233; (c’est-&#224;-dire le potentiel de march&#233; du produit par rapport &#224; la demande totale du march&#233; pour des produits similaires au Canada)</span>
							</div>
							<div class="col-xs-12">
								...
								<span class="mouseHover">Une comparaison avec des produits similaires offerts sur le march&#233; canadien ou d’autres march&#233;s similaires (par exemple &#233;tats-Unis, Union europ&#233;enne, etc.)</span>
							</div>
							<div class="col-xs-6">
								...
								<span class="mouseHover">Un historique des ventes avant l’am&#233;lioration du produit ou un historique des ventes de produits similaires</span>
							</div>
							<div class="col-xs-6">
								...
								<span class="mouseHover">Un plan de marketing ou un plan de produit pour le produit pharmaceutique</span>
							</div>
							<div class="col-xs-6">
					...
					<div class="well well-sm" >
						<div class="row">
							...
							<xsl:when test="fee_details/deferral_request = 'N' and fee_details/fee_remission = 'N'">
								...
								<p>Des frais de 10 000 $ ou moins doivent être soumis au moment du d&#233;pôt de la pr&#233;sentation, le suppl&#233;ment ou la demande. S’il vous plaît remplir le formulaire D&#233;tails du paiement en avance pour pr&#233;sentations de drogues et fiches maîtresses.</p>
								</xsl:when>
								<xsl:otherwise>
								<p>Les frais d’examen ne doivent pas être inclus dans la pr&#233;sentation, le suppl&#233;ment &#224; une pr&#233;sentation ou la demande de drogue. Les factures de plus de 10 000 $ seront envoy&#233;es aux promoteurs.</p>
								</xsl:otherwise>
								</xsl:choose>
							</xsl:when>
							<xsl:when test="fee_details/fee_remission = 'N' and fee_details/deferral_request = 'Y'">
								<p>Vous demandez le report du paiement. Veuillez envoyer le pr&#233;sent formulaire sans aucun paiement.</p>
							</xsl:when>
							<xsl:when test="fee_details/fee_remission = 'Y' and fee_details/deferral_request = 'N'">
								<p>Veuillez payer les frais de traitement de la remise de 590 $ en utilisant les d&#233;tails du paiement en avance pour pr&#233;sentations de drogues et fiches maîtresses.</p>
							</xsl:when>
							<xsl:otherwise>
								<p>Veuillez payer les frais de traitement de la remise de 590 $ en utilisant les d&#233;tails du paiement en avance pour pr&#233;sentations de drogues et fiches maîtresses.</p>
							</xsl:otherwise>
							...
							<div class="col-xs-12">
								<h4>Veuillez s&#233;lectionner tous les modes de paiement que vous avez l’intention d’utiliser.</h4>
							</div>
							<div class="col-xs-12">
					            <strong>
								...
								<span style="font-weight:normal;" class="mouseHover">Option de service de paiement de factures (m&#233;thode pr&#233;f&#233;r&#233;e)</span>&#160;&#160;</strong>
					            <strong>
								...
								<span style="font-weight:normal;" class="mouseHover">Cr&#233;dit existant</span>&#160;&#160;</strong>
					            <strong>
								...
								<span style="font-weight:normal;" class="mouseHover">Transfert bancaire (incluez la confirmation de la banque)</span></strong>
							</div>
							<div class="col-xs-12">
					            <strong>
								...
								<span style="font-weight:normal;" class="mouseHover">MasterCard/Visa/American Express (AMEX)</span>&#160;&#160;</strong>
					            <strong>
								...
								<span style="font-weight:normal;" class="mouseHover">Mandat</span>&#160;&#160;</strong>
					            <strong>
								...
								<span style="font-weight:normal;" class="mouseHover">Traite bancaire internationale</span></strong>
							</div>
							</xsl:if>
						</div>
					</div>
				...
				<div class="panel-body">
					...
					<div class="well well-sm" >
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<strong class="col-xs-2">Code Postal / Code ZIP </strong>
