...
.no-details {
  ...
  .no-details[dir="rtl"] details[open] > summary:before {
	...
	<xsl:template match="DRUG_PRODUCT_ENROL">
		<h1>Product Information Template: Regulatory Enrolment Process (REP) <xsl:if test="software_version != ''">(Version: <xsl:value-of select="software_version"/>)</xsl:if></h1>
		...
		<section>
			<div class="panel panel-default">
				...
				<div class="well well-sm" >
						...
						<div class="row">
							<div class="col-xs-12 form-group">
								<strong>Does this regulatory activity contain an administrative component?&#160; </strong>
						...
						<div class="row">
							<div class="col-xs-12">
								<strong>Reason for administrative component&#160; </strong>
                    ...
                    <xsl:if test="dossier_type/@id != 'D26' ">
						...
						<xsl:if test="/DRUG_PRODUCT_ENROL/importer_record/importer_company_name != ''">
						<div class="row">
						<div class="col-sm-12 form-group">
							<strong>Importer</strong>
							<div class="pull-right">
							  <input id="btn_expandAll_for-importerCompany" type="button" value="Expand All" onclick="javascript:expandAllOrCollapseAll(this)"/>
							  &#160;
							  <input id="btn_collapseAll_for-importerCompany" type="button" value="Collapse All" onclick="javascript:expandAllOrCollapseAll(this)"/>
							</div>
							<table class="table dataTable table-bordered table-hover table-condensed table-striped " id="importerCompany" border="1" cellspacing="2" cellpadding="2" style="table-layout: fixed; width: 100%;word-wrap: break-word;">
								<thead>
								<tr>
														...
														<div class="well well-sm">
															<div class="row">
															  <div class="form-group col-md-12">
															    <strong>Importer Company Name: &#160;</strong><span class="mouseHover"><xsl:value-of select="importer_company_name"/></span>
															  </div>
															</div>
															<div class="row">
															<div class="form-group col-md-12"><strong>Street Address: &#160;</strong><span class="mouseHover"><xsl:value-of select="street_address"/></span></div>
															</div>
															<div class="row">
															...
															<xsl:if test="phone_num != ''">
																<div class="form-group col-md-6"><strong>Phone Number: &#160;</strong><span class="mouseHover"><xsl:value-of select="phone_num"/></span></div>
						...
						<div class="row">
							...
							<xsl:when test=" is_sched_c ='Y' or is_sched_d = 'Y' or is_prescription_drug_list = 'Y' or is_prescription_drug_list = 'Y' or is_regulated_cdsa = 'Y' or is_non_prescription_drug = 'Y' or is_sched_a = 'Y' or is_drug_admin = 'Y'">
								...
								<div class="col-xs-12">
									<xsl:call-template name="hp-checkbox"><xsl:with-param name="value" select="'Y'"/></xsl:call-template>
									<span class="mouseHover">a drug permitted to be sold without a prescription but administered only under the supervision of a practitioner</span>
								</div>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
				...
				<div class="well well-sm">
					<div id="tabpanel0"  class="row">
						<div class="col-xs-12">
							...
							<div class="pull-right">
							  <input id="btn_expandAll_for-formulation" type="button" value="Expand All" onclick="javascript:expandAllOrCollapseAll(this)"/>
							  &#160;
							  <input id="btn_collapseAll_for-formulation" type="button" value="Collapse All" onclick="javascript:expandAllOrCollapseAll(this)"/>
							</div>
						</div>
						...
						<div class="col-xs-12 form-group">
							<table id="formulation" class="table table-hover table-condensed table-striped table-formulation" border="1">
								<thead>
									<tr>
										<th style="width:2%;"></th>
										<th style="width:8%;"><strong>Identifier</strong></th>
									...
									<xsl:for-each select="formulation_group/formulation_details">
										<tr onclick="showDetail(this, '4', true, myTables['formulation']);">
											...
											<td class="out"><table><tr data-detail="true" data-shown="false"><td colspan="4">
												<fieldset>
													<legend><h4>&#160;&#160;&#160;&#160;Formulation &#160;<xsl:value-of select="formulation_id"/></h4></legend>
													<div>
														<section class="panel panel-default">
															<div class="panel-body">
																<div class="well well-sm">
																	...
																	<div id="formulationIngredientRow" class="row">
																	  ...
																	  <div class="form-group col-md-12">
																	    ...
																	    <div class="pull-right">
																	      <input id="btn_expandAll_for-DataTables_Table_0" type="button" value="Expand All" onclick="javascript:expandAllOrCollapseAll(this)"/>
																	      &#160;
																	      <input id="btn_collapseAll_for-DataTables_Table_0" type="button" value="Collapse All" onclick="javascript:expandAllOrCollapseAll(this)"/>
																	    </div>
																	  </div>
																						...
																						<td class="out"><table><tr data-detail="true" data-shown="false"><td colspan="10">
																							<fieldset>
																								...
																								<xsl:if test="ingredient_role/@id = 'NONMED'">
																								  <div class="row">
																									<div class="col-md-6 nowrap">
																									  <strong>I attest that the details for this non-medicinal ingredient are unknown as they are proprietary information.&#160;</strong>
																								...
																								<xsl:if test="ingredient_role/@id = 'NONMED'">
																								  <div class="row">
																									<div class="col-md-6 nowrap">
																									  <strong>The proprietary information can be found in the following:&#160;</strong>
																	...
																	<div class="form-group col-md-12">
																	  <strong>
																	    <xsl:call-template name="getOrder">
																	      ...
																	      .&#160; Was Animal and/or Human Sourced Material (other than the ingredient listed in the formulation above) used at any stage in the manufacturing of the drug?&#160;
																	   </strong>
																	   <div class="pull-right">
																	      <input id="btn_expandAll_for-materialIngredient" type="button" value="Expand All" onclick="javascript:expandAllOrCollapseAll(this)"/>
																	      &#160;
																	      <input id="btn_collapseAll_for-materialIngredient" type="button" value="Collapse All" onclick="javascript:expandAllOrCollapseAll(this)"/>
																	    </div>
																	   <span class="mouseHover">
															...
															<span class="mouseHover"><xsl:call-template name="YesNoUnknow"><xsl:with-param name="value" select="in_final_container"/></xsl:call-template></span>
																	...
																	<div id="containerTypeRow" class="row">
																	  ...
																	  <div class="form-group col-md-12">
																	    <strong>
																	    <xsl:call-template name="getOrder">
																	      <xsl:with-param name="order" select="'E'"/>
																	      <xsl:with-param name="type" select="../../dossier_type/@id"/>
																	    </xsl:call-template>
																	      .&#160;Container Types, Package Size and Shelf Life</strong>
																	    <div class="pull-right">
																	      <input id="btn_expandAll_for-containerType" type="button" value="Expand All" onclick="javascript:expandAllOrCollapseAll(this)"/>
																	      &#160;
																	      <input id="btn_collapseAll_for-containerType" type="button" value="Collapse All" onclick="javascript:expandAllOrCollapseAll(this)"/>
																	    </div>																	
																	  </div>
																    <div class="col-md-12">
																	  <table class="table table-hover table-condensed table-striped table-container" id="containerType" border="1">
																	  <thead>
																		<tr>
																			<th style="width:2%"></th>
																	  ...
																	  <tbody>
																		<xsl:for-each select="container_group/container_details">
																			<tr onclick="showDetail(this, '5', false, []);">
																				...
																				<td><xsl:value-of select="temperature_min"/><xsl:if test="temperature_max != ''">&#160;To&#160;<xsl:value-of select="temperature_max"/></xsl:if></td>
																				<td class="out">
																				  <table>
																				    <tr data-detail="true" data-shown="false"><td colspan="5">
																					  <fieldset>
																						...
																						<div class="row">
																						  <div class="col-md-12">
																						    ...
																						    <span class="normalWeight mouseHover"><xsl:value-of select="package_size"/></span>
																						  </div>
																						</div>
																						<div class="row">
																						  <div class="col-md-6">
																						  ...
																						  <xsl:if test="temperature_max != ''">&#160;&#160;
																						  <strong>To:&#160;</strong>
																						  <span class="normalWeight mouseHover"><xsl:value-of select="temperature_max"/></span></xsl:if>&#160;<strong>Celsius</strong>
																						  </div>
																						</div>
																						<div class="row">
																						  <div class="col-md-12">
																						  ...
																						  <div class="col-md-12">
																							<div class="col-xs-10">
																							  <span class="mouseHover">
																							    <xsl:value-of select="other_shelf_life_considerations"/>
																							  </span>
																							</div>
																						  </div>
																					    </div>
					...
					<div id="tabpanel1" class="row">
						<div class="col-xs-12">
							...
							<div class="pull-right">
								<input id="btn_expandAll_for-appendix" type="button" value="Expand All" onclick="javascript:expandAllOrCollapseAll(this)"/>
								&#160;
								<input id="btn_collapseAll_for-appendix" type="button" value="Collapse All" onclick="javascript:expandAllOrCollapseAll(this)"/>
							</div>
						</div>
						<div class="col-xs-12 form-group">
	...
	<xsl:template name="converter">
		...
		<xsl:choose>
			...
			<xsl:when test=" 'female_paediatric' = $value"><xsl:value-of select="'Female paediatric population (0-18 years of age)'"/></xsl:when>
			<xsl:when test=" 'male_paediatric' = $value"><xsl:value-of select="'Male paediatric population (0-18 years of age)'"/></xsl:when>
			<xsl:when test=" 'female_adult' = $value"><xsl:value-of select="'Female adult population'"/></xsl:when>
			<xsl:when test=" 'male_adult' = $value"><xsl:value-of select="'Male adult population'"/></xsl:when>
			<xsl:when test=" 'phase_1_bioequivalence' = $value"><xsl:value-of select="'Phase I - bioequivalence study (7-day administrative target)'"/></xsl:when>
			<xsl:when test=" 'phase_1_healthy' = $value"><xsl:value-of select="'Phase I - study in healthy humans (30-day default)'"/></xsl:when>
			<xsl:when test=" 'phase_1_other' = $value"><xsl:value-of select="'Phase I - other (30-day default)'"/></xsl:when>
			<xsl:when test=" 'phase_2' = $value"><xsl:value-of select="'Phase II (30-day default)'"/></xsl:when>
			<xsl:when test=" 'phase_3' = $value"><xsl:value-of select="'Phase III (30-day default)'"/></xsl:when>
			<xsl:when test="'ADDITIONAL_PRODUCT_CHGE' = $value">
					...
					<div class="alert alert-info">
						Note: A new dossier identifier maybe required. Contact Health Canada for more information: eReview@hc-sc.gc.ca for drugs for human use and vdd.skmd.so-dgps.dmv.cp@hc-sc.gc.ca for drugs for veterinary use. 
			...
			<xsl:when test="'OWNERSHIP_CHGE' = $value">
					...
					<div class="col-xs-12">
					<div class="alert alert-info">
						Note: Dossier identifier will be transferred from the previous owner if all DINs within the dossier are being transferred. Alternatively, you may contact Health Canada for more information: eReview@hc-sc.gc.ca for drugs for human use and vdd.skmd.so-dgps.dmv.cp@hc-sc.gc.ca for drugs for veterinary use. 
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="no" externalpreview="yes" url="file:///c:/Users/hcuser/Downloads/pi-r234567-2020-08-20-1105.xml" htmlbaseurl="" outputurl="file:///c:/SPM/test/product.html" processortype="saxon8"
